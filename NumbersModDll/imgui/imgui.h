...
struct ImGuiIO
{
    ...
    int         MetricsRenderWindows;           // FloatingNumber of visible windows
    int         MetricsActiveWindows;           // FloatingNumber of active windows
    int         MetricsActiveAllocations;       // FloatingNumber of active allocations, updated by MemAlloc/MemFree based on current context. May be off if you have multiple imgui contexts.
...
struct ImDrawCmd
{
    unsigned int    ElemCount;              // FloatingNumber of indices (multiple of 3) to be rendered as triangles. Vertices are stored in the callee ImDrawList's vtx_buffer[] array, indices in idx_buffer[].
...
struct ImDrawListSplitter
{
    ...
    int                         _Count;      // FloatingNumber of active channels (1+)
...
struct ImDrawData
{
    ...
    int             CmdListsCount;          // FloatingNumber of ImDrawList* to render
...
struct ImFont
{
    ...
    short                       ConfigDataCount;    // 2     // in  // ~ 1        // FloatingNumber of ImFontConfig involved in creating this font. Bigger than 1 when merging multiple font sources into one ImFont.

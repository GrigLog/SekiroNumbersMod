...
struct ImGuiContext
{
    ...
    int                     WindowsActiveCount;                 // FloatingNumber of unique windows submitted by frame
...
struct IMGUI_API ImGuiWindow
{
    ...
    short                   BeginCount;                         // FloatingNumber of Begin() during the current frame (generally 0 or 1, 1+ if appending via multiple Begin/End pairs)
